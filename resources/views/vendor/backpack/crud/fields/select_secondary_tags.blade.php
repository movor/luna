@php
    ...
    if (isset($entry)) {
        $primaryTag = optional($entry)->getPrimaryTag();
    }
...
<div @include('crud::inc.field_wrapper_attributes') >
        ...
        @if (isset($field['model']))
            @foreach ($field['model']::all() as $connected_entity_entry)
                @if(
                    ...
                    // Do not show primary tag in the list of tags
                    && ($connected_entity_entry->id !== optional($primaryTag)->id)
                ))
    ...
    @if(isset($field['select_all']) && $field['select_all'])
        <a class="btn btn-xs btn-default select_all" style="margin-top: 5px;"><i class="fa fa-check-square-o"></i> {{ trans('backpack::crud.select_all') }}
        </a>
        <a class="btn btn-xs btn-default clear" style="margin-top: 5px;"><i class="fa fa-times"></i> {{ trans('backpack::crud.clear') }}
        </a>
    @endif
